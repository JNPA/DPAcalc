...
// SBOX for decryption (attack on last round of encryption AES)
...
__kernel void generateInterVal_aes128invSBox(
    ...
    ) 
{
    ...
    int number = invSBox[ knowndata[trcidx * DATA_SIZE_BYTE + byteidx] ^ keyidx ];
